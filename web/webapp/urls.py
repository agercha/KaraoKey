...
urlpatterns = [
    ...
    path('record-hbd', views.record_hbd, name="record_hbd"),
    path('record-dontstop', views.record_dontstop, name="record_dontstop"),
    ...
    # path('get-chart-from-vals-json', views.get_chart_from_vals_json, name="get_chart_from_vals_json"),
